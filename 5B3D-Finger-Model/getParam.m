...
function param = getParam()
    ...
    param.l1_o = param.l1_r-0.015; % limited minimal length of the compression spring (m)
    ...
    param.l2_r = -deg2rad(20); % Resting angle of the restoration torsion spring (rad)
